...
const DropdownMenuContent = React.forwardRef<
  HTMLDivElement,
  React.ComponentPropsWithRef<typeof DropdownMenuPrimitive.DropdownMenuContent>
...
>(({ className, children, checked, onSelect, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    {...props}
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center bg-gray-300 rounded-sm">
