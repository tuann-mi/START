...
export default function Login() {
    ...
    return (
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md p-8 rounded-lg max-w-md w-full">
            ...
            <button
            onClick={() => window.location.href = 'https://milogin.michigan.gov/eai/login/authenticate?PolicyId=urn:ibm:security:authentication:asf:basicldapuser&Target=https%3A%2F%2Fmiloginci.michigan.gov%2Foidc%2Fendpoint%2Fdefault%2Fauthorize%3FqsId%3D75ecd87a-1cba-431a-b801-e813edbe6d03%26client_id%3D28d60358-8345-4827-9a4d-de796b4159c7'}
