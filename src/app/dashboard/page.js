...
export default function Dashboard() {
  ...
  return (
    <div id="dashboard-page" className="flex w-screen h-full">
      {isOverride ? (
      <>
      <Sidebar onSelectTables={setSelectedTables} />
      <div className="flex-grow p-6 w-96">
        <div>
        ...
        <div className="flex w-full">
          <div className="flex-grow py-4 mt-4 h-full overflow-x-auto">
            {selectedTables.includes('workOrders') && (
              <div className="table-container max-h-96 mb-8 overflow-x-scroll bg-gray-100 dark:bg-gray-800 p-4">
            ...
            {selectedTables.includes('targetActual') && (
              <div className="table-container max-h-96 mb-8 border-2 border-gray-300 overflow-x-scroll">
                <h1 className="text-xl mb-4 text-gray-900 dark:text-white">Target Actual</h1>
                <DataTable data={sortedData(targetActualData)} columns={columns.targetActual} />
              </div>
            )}
            {selectedTables.includes('samplingStatus') && (
              <div className="table-container max-h-96 mb-8 border-2 border-gray-300 overflow-x-scroll">
                <h1 className="text-xl mb-4 text-gray-900 dark:text-white">Sampling Status</h1>
        ...
        <>
        {status === 'unauthenticated' ? (<p className="text-2xl font-bold text-gray-900 dark:text-white text-center">Authenticating...</p>
        ) : (
          <>
          <Sidebar onSelectTables={setSelectedTables} />
          <div className="flex-grow p-6 ml-12">
            ...
            <div className="flex">
          <div className="flex-grow p-4 pl-0 mt-16">
            {selectedTables.includes('workOrders') && (
              <div className="table-container max-h-96 overflow-x-auto mb-8">
                <DataTable data={sortedData(workOrdersData)} columns={columns.workOrders} />
              </div>
            )}
            {selectedTables.includes('targetActual') && (
