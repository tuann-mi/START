  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      if (storedSiteOverviewData && storedAddressInfoData) {
        console.log("storedSiteOverviewData", JSON.parse(storedSiteOverviewData));
        ...
        const fetchData = async () => {
          try {
            ...
            sessionStorage.setItem("siteOverviewData", JSON.stringify(siteOverviewResult));
            sessionStorage.setItem("addressInfoData", JSON.stringify(addressInfoResult));
