  ...
  return (
    <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8 w-1/2">
        ...
        <div className="p-6">
          ...
          <ul className="mt-4 space-y-2">
            {events.map((event, index) => (
              <li
                key={index}
                className="bg-gray-50 dark:bg-gray-700 p-3 rounded-md transition-colors duration-300 hover:bg-gray-100 dark:hover:bg-gray-600"
              >
      ...
      <div className="mt-8">
        <Link
          href="/dashboard"
          className="bg-som-primary text-white px-4 py-2 rounded-md hover:bg-som-secondary dark:hover:bg-som-secondary-dark transition duration-300 ease-in-out"
        >
          Back to Dashboard
        </Link>
      </div>
