        ...
        <form onSubmit={handleAddressSubmit} className="space-y-4 flex flex-col">
          <div className="flex flex-row w-full justify-between items-center">
            <input
              ...
              className="w-full text-sm text-gray-900 dark:text-gray-300 h-10 p-2 mr-2 rounded-md shadow-md"
            />
            <input
              type="text"
              name="streetName"
              ...
              className="w-full text-sm text-gray-900 dark:text-gray-300 h-10 p-2 rounded-md shadow-md"
            />
          </div>
          <div className="flex flex-row w-full justify-between items-center">
            <input
